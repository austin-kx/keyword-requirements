...
if (foundKeywords.length === 0) {
    console.error(
        `❌ For prBody ${prBody} PR body must include keywords describing changes. Include a broad keyword ${broadKeywords.join(", ")}, with a screen ${screens.join(", ")}, or targets ${targets.join(", ")}`,
    );
    process.exit(1);
}
